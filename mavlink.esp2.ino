...
void loop() {
  ...
  mavlink_msg_heartbeat_pack(1,5, &msg, type, autopilot_type, system_mode, custom_mode, system_state);
    ...
    if(mavlink_parse_char(MAVLINK_COMM_0, c, &msg, &status)) {
      ...
      switch(msg.msgid) {
        ...
        case MAVLINK_MSG_ID_RAW_IMU:  // #27: RAW_IMU
          {
            ...
            Serial.println("PX RAW IMU"); Serial.println(raw_imu.xacc);
        ...
        case MAVLINK_MSG_ID_ATTITUDE:  // #30
          {
            ...
            mavlink_attitude_t status;
            mavlink_msg_attitude_decode(&msg, &status);
            Serial.print("Yaw: "); Serial.println(status.yaw);
            // Serial.print("Roll: "); Serial.println(packet.roll);
            // Serial.print("Pitch: "); Serial.println(packet.pitch);
            mavlink_attitude_t attitude;
            mavlink_msg_attitude_decode(&msg, &attitude);
            Serial.println("PX ATTITUDE"); Serial.println(attitude.roll);
          }
        ...
        case  MAVLINK_MSG_ID_GLOBAL_POSITION_INT:
          {
            mavlink_global_position_int_t  status;
            mavlink_msg_global_position_int_decode(&msg, &status);

            Serial.print("Heading: ");
            Serial.print(status.hdg); 
            Serial.println("");
          }
